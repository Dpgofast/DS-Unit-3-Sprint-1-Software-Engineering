...
def generate_products(n=30):
    ...
    for l in range(n):
        ...
        stuff = Product(name, price, weight, flammability)
        tings.append(stuff)
    return tings


def inventory_report(tings):
    '''`inventory_report()` takes a list of products, and prints a "nice"
    summary'''
